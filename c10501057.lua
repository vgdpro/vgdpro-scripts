...
-- 【自】：这张卡被放置到指令区时，选择你的1张先导者，这个回合中，力量+5000。
	vgd.action.AbilityAuto(c,m,loc,EFFECT_TYPE_SINGLE,EVENT_MOVE,cm.op1,nil,cm.con)
	
-- 【自】【指令区】：这张歌曲卡被歌唱时，这个回合中，将当前存在于前列的你所有的单位的力量+5000。
	vgd.action.AbilityAuto(c,m,LOCATION_ORDER,EFFECT_TYPE_FIELD,EVENT_CUSTOM+EVENT_SING,cm.op2,nil,cm.con)
end
