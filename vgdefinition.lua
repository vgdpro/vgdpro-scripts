...
LOCATION_LIST_STRING={"LOCATION_DECK", "LOCATION_HAND", "LOCATION_MZONE", "LOCATION_DROP", "LOCATION_LOCK", "LOCATION_RIDE", "LOCATION_OVERLAY", "LOCATION_EXILE", "LOCATION_DAMAGE", "LOCATION_ORDER", "LOCATION_SPARE", "LOCATION_GCIRCLE", "LOCATION_EMBLEM"}
...
HINTMSG_TO_GCIRCLE		= 519	--请选择要CALL到防卫者圆阵的卡
...
AFFECT_CODE_DEFENDER_CANNOT_TO_GCIRCLE    = VgID + 6      --不能将守护者从手牌CALL到G上
