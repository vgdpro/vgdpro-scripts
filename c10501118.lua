...
function cm.repfilter(c,tp)
    return c:IsControler(tp) and (c:IsLocation(LOCATION_GCIRCLE) or vgf.RMonsterFilter(c)) and c:GetDestination()==LOCATION_DROP and c:IsType(TYPE_MONSTER) and c:IsFaceup() and not cm.filter(c)
end
