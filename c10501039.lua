...
function cm.initial_effect(c)
	...
	vgd.action.AbilityAuto(c,m,LOCATION_CIRCLE,EFFECT_TYPE_FIELD,EVENT_CHAINING,vgf.op.Draw,nil,cm.con1,nil,1)
-- 【永】【G】：你的弃牌区中的宝石卡每有2张，这个单位的盾护+5000。
	vgd.action.AbilityCont(c, m, LOCATION_G_CIRCLE, EFFECT_TYPE_SINGLE, cm.val, EFFECT_UPDATE_DEFENSE, nil)
end
