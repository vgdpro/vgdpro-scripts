...
function cm.initial_effect(c)
    ...
    vgd.action.AbilityAuto(c,m,LOCATION_CIRCLE,EFFECT_TYPE_SINGLE,EVENT_SPSUMMON_SUCCESS,cm.operation,nil,cm.con2,nil,1)
end
function cm.con1(e)
...
function cm.con2(e)
	...
	return vgf.con.RideOnVCircle(e) and g:IsExists(Card.IsCode,1,nil,10501102)
end
