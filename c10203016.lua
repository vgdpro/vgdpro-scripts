...
function cm.initial_effect(c)
	vgd.action.AbilityAuto(c,m,LOCATION_CIRCLE,EFFECT_TYPE_SINGLE,EVENT_BATTLED,cm.operation,vgf.cost.And(vgf.cost.SoulBlast(1),vgf.cost.Retire()),cm.condition)
end
